...
export const defaultOpenAIConfig: OpenAIConfig = {
  ...
  models: {
    planning: {
      modelName: process.env.OPENAI_PLANNING_MODEL || 'gpt-4.1',
      fallbackModel: 'gpt-4o',
      temperature: 0.7,
      maxTokens: 64000,
    },
    schema: {
      modelName: process.env.OPENAI_SCHEMA_MODEL || 'gpt-4.1',
      fallbackModel: 'gpt-4o',
      temperature: 0.5,
      maxTokens: 64000,
    },
    content: {
      modelName: process.env.OPENAI_CONTENT_MODEL || 'gpt-4.1',
      fallbackModel: 'gpt-4o',
      temperature: 0.7,
      maxTokens: 64000,
    },
